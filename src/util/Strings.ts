export default class Strings {
    ...
    public static USER_ALREADY_REGISTERED = 'User is already registered';
    public static REGISTRATION_SUCCESS = 'Successfully registered user';
    public static USER_REMOVAL_SUCCESS = 'Successfully removed user';
}
